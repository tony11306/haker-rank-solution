...
// this problem took me a week to think, and I still can't find the better solution that won't exceed the time limit. So I copy other's solution, which is based on counting sort.
// I hope that I can someday solve it by using fenwick tree or segment tree.
...
int getTwiceMedian( vector<int> &A, vector<int> &count,int d)
{
    ...
    {
        // cout << countfreq[i] << " " << countfreq[i-1] << endl;
